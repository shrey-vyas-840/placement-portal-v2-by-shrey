  ...
  return (
    ...
    >
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>Execution Mode</DialogTitle>

          <DialogDescription>Choose how this stage will be conducted.</DialogDescription>
        </DialogHeader>
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <Card
            ...
            className={`cursor-pointer border-2 transition-all ${
              mode === "SINGLE" ? "border-primary bg-primary/5" : "hover:border-primary/40"
            }`}
          >
            <div className="flex h-full flex-col p-5">
              <Users className="mb-4 h-8 w-8" />

              <h3 className="font-semibold">Single Execution</h3>
          ...
          <Card
            ...
            className={`cursor-pointer border-2 transition-all ${
              mode === "MULTIPLE" ? "border-primary bg-primary/5" : "hover:border-primary/40"
            }`}
          >
            <div className="flex h-full flex-col p-5">
              <GitBranch className="mb-4 h-8 w-8" />

              <h3 className="font-semibold">Multiple Execution Batches</h3>

              <p className="mt-2 text-sm text-muted-foreground">
                Split shortlisted students into multiple scheduled execution batches for this stage.
              </p>
            </div>
          </Card>
        </div>
        ...
        <DialogFooter className="mt-6">
          ...
          <Button onClick={() => onContinue(mode)} disabled={loading}>
            Continue
          </Button>
        </DialogFooter>
      </DialogContent>
