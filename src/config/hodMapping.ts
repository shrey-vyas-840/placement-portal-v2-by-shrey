...
export const DEFAULT_HOD_EMAIL =
    "shrey36870@gmail.com";

export const NOC_EMAIL_CONFIG = {

    DEPUTY_TNP_EMAIL:
        "deputy.tnp@indusuni.ac.in",

    PLACEMENT_CELL_EMAIL:
        "placement@indusuni.ac.in",
...
export const HOD_EMAILS = {
    ...
    IIICT: {
        ...
        "B.Sc": {
            ...
            "Computer Application (CA) & Information Technology (IT)":
                DEFAULT_HOD_EMAIL,

            "Clinical Research and Health Care Management (Hons)":
                DEFAULT_HOD_EMAIL,
...
export function getHodEmail(
    ...
    return (
        HOD_EMAILS?.[
            institute as keyof typeof HOD_EMAILS
        ]?.[
            degree as keyof typeof HOD_EMAILS[
                keyof typeof HOD_EMAILS
            ]
        ]?.[
            branch as any
        ]
...
export function isValidEligibilityPath(
    institute: string,
    degree: string,
    branch: string
) {
