  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        setStep(stageToStep(existingDraft.onboarding_stage));
        setLoading(false);
      } catch (err) {
        console.error(err);
  ...
  const handleFinalConfirm = async () => {
    ...
    try {
      ...
      await completeDraft({
        ...
        onboardingStage: registryFound
          ? "PENDING_PROFILE_VERIFICATION"
          : "PENDING_NEW_STUDENT_APPROVAL",
        enrollmentNo: normalizeEnrollment(enteredEnrollment),
        passwordCreated: true,
        registryFound,
        registrySnapshot,
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      ...
                      <div className="sm:col-span-2">
                        ...
                        <select
                          ...
                          disabled={placementPreferenceLocked}
                          onChange={(e) => {
                        ...
                        {showPlacementPreferenceWarning ? (
                          <div className="mt-2 rounded-xl border border-amber-200 bg-amber-50 p-3 text-sm text-amber-900">
                            Your current placement preference indicates that you are not
                            participating in placement activities. To become placement eligible
                            again, submit a change request which must be approved by the Training &
                            Placement Cell.
                          </div>
                        ) : null}
                      </div>
                ...
                <div className="space-y-6">
                  ...
                  {requiresOptOut ? (
                    <div className="rounded-2xl border border-amber-200 bg-amber-50 p-4 text-amber-900">
                      ...
                      <div className="mt-4">
                        <label className="mb-1 block text-sm font-medium">Opt-Out Reason</label>
                        <textarea
                          value={optOutReason}
                  ...
                  <div className="rounded-2xl border border-border bg-background p-4">
                    ...
                    <div className="space-y-4">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex rounded-xl border border-border bg-card px-4 py-2 text-sm font-medium"
                      >
