  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-7xl px-6 py-8">
        ...
        <form onSubmit={handleSubmit} className="mt-6 rounded-lg border p-5 space-y-4">
          <div>
          ...
          <div>
            <label className="mb-1 block font-medium">Company Website</label>
          ...
          <div>
            <label className="mb-1 block font-medium">Hiring Location</label>
          ...
          <div>
            <label className="mb-1 block font-medium">Industry Type</label>
          ...
          <div>
            <label className="mb-1 block font-medium">Company Description</label>
          ...
          <div>
            <label className="mb-1 block font-medium">Company Size</label>
            ...
            <tbody>
              {companies.map((company) => (
                <tr key={company.company_id} className="border-b">
                  ...
                  <td className="p-3">{company.hiring_location}</td>

                  <td className="p-3">{company.industry_type}</td>
                  <td className="p-3">
                    <button
