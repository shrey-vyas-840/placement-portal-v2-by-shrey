...
export function AdminAllOpportunitiesPage() {
  ...
  const filteredOpportunities = useMemo(() => {
    ...
    return (opportunities || []).filter((opp) => {
      ...
      const searchMatch = !searchText || company.includes(searchText) || title.includes(searchText);
      ...
      const periodMatch = !cutoff || (createdAt ? createdAt >= cutoff : true);
            ...
            {filteredOpportunities.map((opportunity) => (
              ...
              >
                ...
                <div className="mt-5 space-y-2 text-sm">
                  ...
                  <p>
                    Eligible Candidates: <b>{opportunity.eligibleCount ?? 0}</b>
                  </p>

                  <p>
                    Applied Students: <b>{opportunity.appliedCount ?? 0}</b>
                  </p>

                  <p>
                    Not Applied: <b>{opportunity.unappliedCount ?? 0}</b>
                  </p>
