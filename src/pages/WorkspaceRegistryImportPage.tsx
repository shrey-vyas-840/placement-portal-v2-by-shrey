          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm text-muted-foreground">
                Upload the institute Excel sheet, validate the exact header order, dedupe by latest
                timestamp, scan conflicts against the registry table, and import only clean rows.
              </p>
            </div>
        ...
        <section className="grid gap-6 lg:grid-cols-[360px_minmax(0,1fr)]">
          <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Use the same Excel format. The validator blocks bad rows before anything reaches the
              database.
            </p>
            ...
            <div className="mt-5 space-y-4">
              ...
              <div>
                <label className="mb-2 block text-sm font-medium">Excel File (.xlsx)</label>
                ...
                >
                  ...
                  <label htmlFor="registry-file-upload" className="cursor-pointer">
                    <div className="space-y-2">
                      <div className="text-lg font-semibold">Drag & Drop Excel File</div>

                      <div className="text-sm text-muted-foreground">or click here to browse</div>
          ...
          <div className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
              ...
              <StatCard
                label="Rows Ready"
                value={report?.importedRowsCount ?? 0}
              ...
              <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
                  ...
                  <div className="rounded-xl border border-border bg-background p-4 text-sm">
                    ...
                    <div className="mt-1 font-medium">{report.readyToImport ? "Yes" : "No"}</div>
                  </div>
            ...
            <div className="mt-4 overflow-x-auto">
              <table className="min-w-[1200px] w-full text-sm">
                ...
                <tbody>
                  {report.rows.map((row) => (
                    <tr
                      key={`${row.rowNumber}-${row.enrollmentNo}`}
