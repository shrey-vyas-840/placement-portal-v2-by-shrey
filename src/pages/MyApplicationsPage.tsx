                ...
                <div className="mt-8 grid gap-4 md:grid-cols-3">
                    ...
                    <div className="rounded-3xl border bg-white p-5 shadow-sm">
                        ...
                        <h3 className="mt-2 text-3xl font-bold text-blue-600">
                            {
                                applications.filter(
                                    x => x.application_status === "Applied"
                                ).length
                            }
                        </h3>
                    </div>
                    ...
                    <div className="rounded-3xl border bg-white p-5 shadow-sm">
                        ...
                        <h3 className="mt-2 text-3xl font-bold text-green-600">
                            {
                                applications.filter(
                                    x => x.application_status === "Shortlisted"
                                ).length
                            }
                        </h3>
                    </div>
                    ...
                    <div className="rounded-3xl border bg-white p-5 shadow-sm">
                        ...
                        <h3 className="mt-2 text-3xl font-bold text-green-600">
                            {
                                applications.filter(
                                    x => x.application_status === "Interview Scheduled"
                                ).length
                            }
                        </h3>
                    </div>
                    ...
                    <div className="rounded-3xl border bg-white p-5 shadow-sm">
                        ...
                        <h3 className="mt-2 text-3xl font-bold text-red-600">
                            {
                                applications.filter(
                                    x => x.application_status === "Rejected"
                                ).length
                            }
                        </h3>
                    </div>
                    ...
                    <div className="rounded-3xl border bg-white p-5 shadow-sm">
                        ...
                        <h3 className="mt-2 text-3xl font-bold text-green-600">
                            {
                                applications.filter(
                                    x => x.application_status === "Selected"
                                ).length
                            }
                        </h3>
                    </div>
